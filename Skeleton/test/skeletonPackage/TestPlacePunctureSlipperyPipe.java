...
public class TestPlacePunctureSlipperyPipe {
	@Test
	public void test28() {
		String[] command = new String[] {"load", "C:/Projlab/8", "test28.txt"};
	...
	@Test
	public void test29() {
		String[] command = new String[] {"load", "C:/Projlab/8", "test29.txt"};
		Program.load(command);
	...
	@Test
	public void test30() {
		String[] command = new String[] {"load", "C:/Projlab/8", "test30.txt"};
		Program.load(command);
	...
	@Test
	public void test31() {
		String[] command = new String[] {"load", "C:/Projlab/8", "test31.txt"};
		Program.load(command);
	...
	@Test
	public void test32() {
		String[] command = new String[] {"load", "C:/Projlab/8", "test32.txt"};
		Program.load(command);
		assertEquals(Program.getPipes().get("pipe_1").getState(), StateOfPipe.SLIPPERY);
